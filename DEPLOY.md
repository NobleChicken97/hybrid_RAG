...
- Live costs (~2026-09-05): Lightsail 4 GB instance ~$24/mo flat + automatic snapshots (small $/GB-mo) + ECR image storage (~few $/mo, capped by keep-3 lifecycle). No transfer surprises at demo traffic.
